...
# N estimation
# solve QP
M_dr1, P, q = find_pq_S(deaths, p, N_max, dr1)
...
# S_dr1 = S0[:-(death_delay_max-death_delay_min-1)]
# N_dr1 = N0_dr1[:-(death_delay_max-death_delay_min-1)]

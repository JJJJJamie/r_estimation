...
N3_start = ind_min-death_delay_max+1
...
pol_dates = [0,
             pol_list[0]-N3_start+1,
             pol_list[1]-N3_start+1,
             pol_list[2]-N3_start+1,
             pol_list[3]-N3_start+1,
...
# N estimation
# solve QP
M3, P, q = find_pq_S(deaths, p, N_max, dr)
...
N3 = N0_3+0.
N3_range = np.arange(N3_start, N3_start+len(N3))

# cut off last (death_delay_max-death_delay_min-1) estimations
# S = S0[:-(death_delay_max-death_delay_min-1)]
# N3 = N0_3[:-(death_delay_max-death_delay_min-1)]
# N3_range = np.arange(N3_start, N3_start+len(N3))

# test results
# plt.plot(S)
# plt.plot(nn_cum[N3_start:])
#
# plt.plot(c)
# plt.plot(c_max)
# plt.plot(c_min)
# plt.plot(cc[N3_start:])
#
# plt.plot(np.dot(M3, N0_3) - deaths)

...
N1_start = ind_min-death_delay_max+1
...
pol_dates = [0,
             pol_list[0]-N1_start+1,
             pol_list[1]-N1_start+1,
             pol_list[2]-N1_start+1,
             pol_list[3]-N1_start+1,
...
# N estimation
# solve QP
M1, P, q = find_pq_S(deaths, p, N_max, dr)
...
N1 = N0_1+0.
N1_range = np.arange(N1_start, N1_start+len(N1))

# cut off last (death_delay_max-death_delay_min-1) estimations
# S = S0[:-(death_delay_max-death_delay_min-1)]
# N1 = N0_1[:-(death_delay_max-death_delay_min-1)]
# N1_range = np.arange(N1_start, N1_start+len(N1))

# test results
# plt.plot(S)
# plt.plot(nn_cum[N1_start:])
#
# plt.plot(c)
# plt.plot(c_max)
# plt.plot(c_min)
# plt.plot(cc[N1_start:])
#
# plt.plot(np.dot(M1, N0_1) - deaths)
